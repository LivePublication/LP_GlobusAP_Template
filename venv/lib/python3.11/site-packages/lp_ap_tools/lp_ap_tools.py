...
LP_FIELDS = {
   ...
   'researcher_name': (str, Field(..., title="Some required input", description="A useful description"))
}
...
def create_action(crate: ROCrate, 
   ...
   action = crate.add(SoftwareApplication(
      ...
      properties={
         "AP_name": ap_apbt.name,
         "AP_description": ap_description.description,
         "AP_url": raw_request[0].url
      }
   ))
